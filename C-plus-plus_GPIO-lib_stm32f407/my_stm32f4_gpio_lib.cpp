...
GPIO_PinState Gpio:: LIB_LIB_ReadPin(GPIO_typeDef *GPIOx, uint16_t GPIO_Pin){
...
void Gpio:: LIB_GPIO_Write_Pin(GPIO_typeDef *GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState){
